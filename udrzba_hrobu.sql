...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Stř 20. pro 2023, 10:35
...
--
-- Struktura tabulky `kontaktni_formular`
--
...
--
-- Indexy pro tabulku `kontaktni_formular`
--
ALTER TABLE `kontaktni_formular`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pro tabulku `kontaktni_formular`
--
ALTER TABLE `kontaktni_formular`
